...
// globals.css, and <Analytics/> stay in the root layout above this one.
    ...
    <>
      <header className="sticky top-0 z-30 flex items-center gap-7 max-w-[1240px] w-full mx-auto px-10 py-[22px] bg-bg/90 backdrop-blur-md border-b border-line max-[640px]:px-5 max-[640px]:py-[18px] max-[640px]:gap-4 max-[640px]:bg-bg max-[640px]:backdrop-blur-none">
        ...
        <div className="ml-auto flex items-center gap-4 shrink-0">
          <a
            href="https://github.com/helius-labs/rpc-perf-dash#run-the-benchmark-yourself"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Verify yourself — run the benchmark against your own RPC endpoints"
            title="Run the benchmark yourself against your own RPC endpoints"
            className="hidden md:inline-flex shrink-0 items-center rounded-full border border-line px-3 py-[5px] font-geistmono text-[11px] font-medium text-fg hover:bg-surface hover:no-underline whitespace-nowrap"
          >
            Verify yourself
          </a>
          <HeaderStatus />
