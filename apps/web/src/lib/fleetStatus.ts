 ...
 * and intentionally not gated on the utility endpoint — its health signal is
 * secondary and surfaced in full on /status.
 */
...
export function buildFleetSummary(health: {
  ...
  return {
    ...
    utility: { healthy: health.utility.healthy },
