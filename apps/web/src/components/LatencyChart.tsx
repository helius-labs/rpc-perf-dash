...
// 7d → rollups_1h (hourly), 30d → rollups_1d (daily). Client-side binning can
...
export function LatencyChart({
  ...
  const controlBar = (
    <div className="flex flex-col gap-3 py-3 border-y border-line mb-4 md:flex-row md:flex-wrap md:items-center md:gap-x-[22px] md:gap-y-3.5 md:py-3.5">
      {filters}
      {showRpcFilter && (
