...
export function FilterPill({
  ...
  // onPointerEnter prefetch: this page is force-dynamic, so Next won't
  // auto-prefetch the target render — warming it on hover makes the click land
  // faster once the user commits.
  return (
    <Link
      href={href as Route}
      scroll={false}
      prefetch={false}
      onPointerEnter={() => router.prefetch(href as Route)}
