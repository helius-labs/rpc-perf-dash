            ...
            >
              ...
              <div className="flex items-center gap-2 px-5 pb-5">
                <button
                  type="button"
                  onClick={onTweet}
                  className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-accent px-4 py-2.5 text-[13px] font-medium text-white transition-colors hover:bg-accent/90 cursor-pointer"
                >
