...
|---|---|
| AWS account | `CDK_DEFAULT_ACCOUNT` (from your AWS credentials) or `AWS_ACCOUNT_ID`; profile via `AWS_PROFILE` (default `experiments-admin`) |
...
`docs/operations.md` is the full runbook: deploy order, per-cloud gotchas, and
recovery.
