...
4. Copy `.env.example` to `.env.local` and fill in:
   ...
   - `GENERATOR_SECRET` — the commit-reveal HMAC secret the generator needs. Generate with `openssl rand -hex 32`.
...
required). See `docs/operations.md` for the full multi-cloud runbook.
