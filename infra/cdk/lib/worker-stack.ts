...
import { secretEnv, linuxAmd64Image, NEON_WORKER_SECRET_KEYS, PANEL_SECRET_KEYS } from "./util.js";
...
export class WorkerStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: WorkerStackProps) {
    ...
    taskDef.addContainer("worker", {
      ...
      // Workers call the panel directly; no utility keys (the utility endpoint
      // is generator-side only).
      secrets: secretEnv(props.secret, [...NEON_WORKER_SECRET_KEYS, ...PANEL_SECRET_KEYS]),
    });
