 ...
 * predicate or be compared against `referenceTipSlot`. Consensus/auditor group
...
/** Tight consensus tolerance (~4 blocks) / wide auditor tolerance (~150). */
export const HEIGHT_TOLERANCE = 4;
export const HEIGHT_AUDITOR_TOLERANCE = 150;
...
export const blockHeightProjectionsMatchAuditor = valueWithin(HEIGHT_AUDITOR_TOLERANCE);
