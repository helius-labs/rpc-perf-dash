 ...
 * joining/leaving/delinquency-flipping validators. Auditor reuses the consensus
 * predicate (Jaccard absorbs intra-window churn). Wired in record.ts.
 */
...
export type GetVoteAccountsBucket = (typeof BUCKETS)[number];
