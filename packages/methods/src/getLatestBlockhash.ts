 ...
 * returned `context.slot` (tight tolerance — wired in record.ts via the shared
 * freshness predicate), and correctness is a freshness verdict. On TOP of freshness, `classify` applies a well-formedness gate (the
