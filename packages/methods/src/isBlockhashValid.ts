 ...
 *   - "valid":   a blockhash freshly fetched from the auditor at derivation. It
 ...
 * Project `{ valid }`; byte-equal consensus + auditor.
 */
...
export async function deriveIsBlockhashValidChallenge(
  ...
  // valid: fetch a fresh blockhash from the auditor.
  try {
