 ...
 * it is scored exactly like getSlot: consensus on slot tolerance (±4),
 * correctness = freshness verdict. The predicate is wired in record.ts to
 * getSlot's `slotProjectionsMatch`.
 */
