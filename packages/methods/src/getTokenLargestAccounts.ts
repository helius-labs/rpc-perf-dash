 ...
 * The auditor cross-check reuses the same predicate (Jaccard already absorbs
 * the intra-set churn between the t=0 auditor capture and the t+δ panel), wired
 * in record.ts. Tune the threshold against live boundary-swap rates.
 */
...
/** Consensus / auditor match: Jaccard over the holder address sets. */
